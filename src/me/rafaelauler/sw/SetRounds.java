...
/* 24 */     if (!p.hasPermission("sw.setlobby")) {
/* 25 */       p.sendMessage("§cYou dont have the permission sw.setlobby");
/* 26 */       return true;
/*    */     }
...
/*    */     
/* 35 */     if (args.length == 0) {
/* 36 */       p.sendMessage("§cUse /setswlobby <spawn, quit>");
/* 37 */       return true;
/*    */     }
...
/*    */       }
/* 51 */       p.sendMessage("§aSKYWARS Spawn Setted with sucess!");
/* 52 */       return true; }
/* 53 */     
...
/* 80 */       return true;
/*    */     }
/* 82 */     p.sendMessage("§cCorrect Usage: /swsetlobby <spawn/quit>");
/*    */     
/*    */ 
/* 85 */     return false;
/*    */   }
